...
{
    /** @const */
    var ON_LOCALHOST = !location.hostname.endsWith("justinmichaud.com");
    ...
    function onload()
    {
        ...
        var oses = [
            ...
            },
            {
                ...
                vga_bios: { url: "../bios/vgabios.bin" },
                filesystem: {
                    baseurl: host + "debian-rootfs-flat",
                    basefs: host + "debian-fs.json",
                    async: false,
                },
                autostart: true,
                bzimage_initrd_from_filesystem: true,
            ...
            },
            {
                ...
                // state: {
                //     url: "https://justinmichaud.com/js-ctf/v86state.bin",
                // },
